...
const GigCard = ({ item }) => {
  return (
    <Link to="/gig/123" className="block">
      <div className="w-[324px] h-[450px] border border-[#e4e4e4] mb-10">
        ...
        <div className="px-5 py-2.5 flex flex-col gap-5">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[#ffc108] font-bold text-[14px]">{item.star}</span>
          </div>
        </div>
        <hr className="border-t border-[#e4e4e4]" />
        <div className="px-5 py-2 flex items-center justify-between">
          <img src="./img/heart.png" alt="" className="w-[16px] h-[16px] cursor-pointer object-cover" />
